...
require_relative 'lib/homebus-covid-covidactnow/version'

Gem::Specification.new do |spec|
  spec.name = 'homebus-covid-covidactnow'
  spec.version = HomebusCovidCovidactnow::VERSION
  ...
  spec.homepage = 'https://github.com/HomeBusProjects/homebus-covid-covidactnow'
  spec.license = 'MIT'
  spec.required_ruby_version = ">= #{File.read('.ruby-version')}"

  spec.metadata['homepage_uri'] = spec.homepage
  spec.metadata['source_code_uri'] = 'https://github.com/HomeBusProjects/homebus-covid-covidactnow'
